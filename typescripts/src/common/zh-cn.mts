export default {
    ...
    // comfy node title
    'SDPPP Get Document': '废弃节点! 获取文档(GetDocument)',
    'SDPPP Get Layer By ID': '废弃节点! 获取图层(GetLayer)',
    'SDPPP Get Linked Layers': '废弃节点! 获取链接图层(GetLinkedLayers)',
    'SDPPP Get Layers In Group': '废弃节点! 获取组中图层(GetLayersInGroup)',
    'SDPPP Get Text From Layer': '废弃节点! 获取图层文本(GetTextFromLayer)',
    'SDPPP Parse Layer Info': '废弃节点! 解析图层信息(ParseLayerInfo)',
    'SDPPP Get Selection': '废弃节点! 获取选区(GetSelection)', 
    'SDPPP Get Image From Photoshop': '废弃节点! 从PS获取图像(GetImageFromPhotoshop)',
    'SDPPP Send Images To Photoshop': '废弃节点! 发送图像到PS(SendImagesToPhotoshop)',
    'SDPPP Send Text To Layer': '废弃节点! 发送文本到图层(SendTextToLayer)',
